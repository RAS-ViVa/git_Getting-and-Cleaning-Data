...
##Goal of the Project
It should create one R script called run_analysis.R that does the following.
...
##Dependencies
Required packages - plyr,dplyr, redhape, stats, date.table

##Run source ("run_analysis.R"), 
then it will load necessary input data set, generate a new file newTidySet.txt with the average of each variable for each activity and each subject in your working directory.
